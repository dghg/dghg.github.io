...
첫번째로 **input gate**는 cell에 입력할지 결정하는 gate가 되고, $$ i = \sigma(W_{xh_1}x_{t}+W_{hh_2}h_{t-1}) $$ 입니다. 
...
먼저 $$ c_{t} $$ 의 경우 이전 셀인 $$ c_{t-1} $$와 $$ i, f, g $$를 이용해 $$ c_{t} = f\odatc_{t-1} + i\odatg $$로 나타낼 수 있습니다.  
또한 $$ h_{t} $$ 는 $$ h_{t} = o\odattanh(c_{t}) $$로 계산할 수 있습니다.
